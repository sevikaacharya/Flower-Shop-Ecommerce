  ...
  return (
    <div className='flex justify-self-center para mt-20 leading-10 text-center'>
        <div className=''>
            ...
            <p className=' text-xl'>Make Every Occasion Bloom With Beauty</p>
            <p className='text-xl'>Planning a special event or surprise? Whether it’s a wedding, anniversary, birthday, or corporate gathering — let us design the perfect floral experience for you.</p>
            <p className=' mt-5 font-bold'>What We Offer:</p>
             ...
             <p className='font-bold text-xl mt-10'>✨ Let flowers speak your feelings — effortlessly and beautifully.</p>
